import { Instagram, Linkedin, Mail, MapIcon, MapPin, Phone, Send } from "lucide-react";
...
export const ContactSection = () => {
    ...
    return(
        <section id="contact" className="py-24 px-4 relative bg-secondary/30">
            ...
            I'm always excited to learn, collaborate, or take on new challenges. Feel free to reach out 
            if you have opportunities, questions, or just want to connect!
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div className="space-y-8">
                    ...
                    <div className="space-y-6 justify-center">
                        <div className="flex items-center space-x-4">
                            ...
                            <div className="flex flex-col text-left">
                                <h4 className="font-medium text-sm leading-none text-left">
                                    Email</h4>
                                <a 
                    ...
                    <div className="pt-8">
                        ...
                        <div className="flex space-x-4 justify-center">
                            ...
                            className="text-muted-foreground hover:text-primary transition-colors"
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" className="h-6 w-6 fill-current">
                ...
                <div className="bg-card p-8 rounded-lg shadow-xs">
                    ...
                    <form
                        action="https://formsubmit.co/ayushmishra2004op@gmail.com"
                        method="POST"
                        onSubmit={() => {
